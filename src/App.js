...
const App = ()=> {
  ...
  const pageSize = 5;
  const apiKey = process.env.REACT_APP_NEWS_API;   // <-- Correct place
      ...
      <Router>
        ...
        <Switch>
          ...
          <Route exact path="/general">
            <News setProgress={setProgress} apiKey={apiKey} key="general2" pageSize={pageSize} country="in" category="general"/>
          </Route>
